...
#' When a dark theme is applied, all geom color and geom fill defaults are changed
#' to make them visible against a dark background. To restore the defaults to
#' their original values, use [update_geom_colors()].
#'
#' @docType package
#' @name ggdark
NULL
